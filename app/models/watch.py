...
class Watch(BaseModel):
    ...
    price: Optional[float] = Field(None, description="Parsed numeric price in USD/currency, null if Price On Request")
    is_por: bool = Field(False, description="Flag indicating if price is Price On Request (POR)")
    complications: List[str] = Field(default_factory=list, description="List of watch complications")
